<div class="tab-group">
    <div class="tab-item tab-item-active">
        <div class="tab-cols">
			<div class="two-col">
				<div class="col bordered-right">
					...
					<ul class="fp-wrap-list">
						<li><?php _e('You save time creating, upgrading and managing your websites.', FRESH_TEXT_DOMAIN); ?></li>
						<li><?php _e('Your visitors get a faster loading website and your conversion rates increase', FRESH_TEXT_DOMAIN); ?></li>
						<li><?php _e('Search Engines love your faster, more reliable websites meaning better rankings and more traffic', FRESH_TEXT_DOMAIN); ?></li>
						<li><?php _e('You get all the crucial information at your fingertips, allowing you to effortlessly grow your websites', FRESH_TEXT_DOMAIN); ?></li>
						<li><?php _e('You never have to worry about downtime, tricky upgrades or complicated servers again', FRESH_TEXT_DOMAIN); ?></li>
			...
			<div class="two-col">
				<div class="col bordered-right">
					<h2 class="col-title"> <?php esc_html_e('Where can I ask a question and get help?', FRESH_TEXT_DOMAIN); ?></h2>
