...
class Fastpress_Updater_UpdateManager
{
    ...
    /**
     *
     * @return Fastpress_Updater_PluginUpdate|null
     */
    public function getPluginUpdate($pluginBasename)
    {
        require_once(FRESH_CONNECT_DIR_PATH .'inc/Updater/PluginUpdate.php');
        ...
        $update           = new Fastpress_Updater_PluginUpdate();
        $update->id       = $info->id;
     ...
     *
     * @return Fastpress_Updater_ThemeUpdate|null
     */
    public function getThemeUpdate($themeSlug)
    {
        require_once(FRESH_CONNECT_DIR_PATH .'inc/Updater/ThemeUpdate.php');
        ...
        $update          = new Fastpress_Updater_ThemeUpdate();
    ...
    /**
     * @return Fastpress_Updater_PluginUpdate[]
     */
    ...
    /**
     * @return Fastpress_Updater_ThemeUpdate[]
     */
    ...
    {
        require_once(FRESH_CONNECT_DIR_PATH .'inc/Updater/CoreUpdate.php');
        ...
        if ($latestUpdate !== null) {
            $showUpdate               = new Fastpress_Updater_CoreUpdate();
